...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<Crm.Models.Crm.Account>("Accounts");
          oDataBuilder.EntitySet<Crm.Models.Crm.AccountRelationType>("AccountRelationTypes");
          oDataBuilder.EntitySet<Crm.Models.Crm.Address>("Addresses");
          oDataBuilder.EntitySet<Crm.Models.Crm.Contact>("Contacts");
          oDataBuilder.EntitySet<Crm.Models.Crm.Country>("Countries");
          oDataBuilder.EntitySet<Crm.Models.Crm.Role>("Roles");
          oDataBuilder.EntitySet<Crm.Models.Crm.User>("Users");

          var userRole = oDataBuilder.EntitySet<Crm.Models.Crm.UserRole>("UserRoles");
