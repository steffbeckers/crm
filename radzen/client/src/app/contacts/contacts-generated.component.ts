...
export class ContactsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.crm.getContacts(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Account`, null, null)
  ...
  grid0RowSelect(event: any) {
    ...
    this.router.navigate(['edit-contact', event.Id]);
  }
}
