/*
  ...
  Modify edit-account.component.ts instead.
*/
...
export class EditAccountGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  canEdit: any;
  account: any;
  getByAddressesForAddressIdResult: any;
  getByAccountsForParentAccountIdResult: any;
  getByAccountsForBillingAccountIdResult: any;
  getByAccountRelationTypesForRelationTypeIdResult: any;
  getByContactsForPrimaryContactIdResult: any;
  getByUsersForCreatedByIdResult: any;
  getByUsersForModifiedByIdResult: any;
  ...
  load() {
    ...
    this.crm.getAccountById(null, `${this.parameters.Id}`)
    .subscribe((result: any) => {
      this.account = result;

      if (this.account.AddressId != null) {
              this.crm.getAddressById(null, `${this.account.AddressId}`)
        .subscribe((result: any) => {
              this.getByAddressesForAddressIdResult = result;
        }, (result: any) => {
      
        });
      }

      if (this.account.ParentAccountId != null) {
              this.crm.getAccountById(null, `${this.account.ParentAccountId}`)
        .subscribe((result: any) => {
              this.getByAccountsForParentAccountIdResult = result;
        }, (result: any) => {
      
        });
      }

      if (this.account.BillingAccountId != null) {
              this.crm.getAccountById(null, `${this.account.BillingAccountId}`)
        .subscribe((result: any) => {
              this.getByAccountsForBillingAccountIdResult = result;
        }, (result: any) => {
      
        });
      }

      if (this.account.RelationTypeId != null) {
              this.crm.getAccountRelationTypeById(null, `${this.account.RelationTypeId}`)
        .subscribe((result: any) => {
              this.getByAccountRelationTypesForRelationTypeIdResult = result;
        }, (result: any) => {
      
        });
      }

      if (this.account.PrimaryContactId != null) {
              this.crm.getContactById(null, `${this.account.PrimaryContactId}`)
        .subscribe((result: any) => {
              this.getByContactsForPrimaryContactIdResult = result;
        }, (result: any) => {
      
        });
      }

      if (this.account.CreatedById != null) {
              this.crm.getUserById(null, `${this.account.CreatedById}`)
        .subscribe((result: any) => {
              this.getByUsersForCreatedByIdResult = result;
        }, (result: any) => {
      ...
      if (this.account.ModifiedById != null) {
              this.crm.getUserById(null, `${this.account.ModifiedById}`)
        .subscribe((result: any) => {
              this.getByUsersForModifiedByIdResult = result;
        }, (result: any) => {
  ...
  form0Submit(event: any) {
    this.crm.updateAccount(null, `${this.parameters.Id}`, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Account` });
    });
  }
}
